...
file = io.open("script_pointers_"..language..".json","w")

file:write("{\n")

byte_array = mainmemory.read_bytes_as_array(start_script_pointers[language] - 0x2000000, (max_cmd_id+1)*4)
